...
CREATE TABLE crm1.transporters (
...
CREATE TABLE crm1.orders (
  ...
  CONSTRAINT id_cl
  FOREIGN KEY (id_cl)
  REFERENCES crm1.clients (id_cl)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT id_emp
  FOREIGN KEY (id_emp)
  REFERENCES crm1.employees (id_emp)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT id_tran
  FOREIGN KEY (id_tran)
  REFERENCES crm1.transporters (id_tran)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
