<div class="container">
    <table class="table">
        ...
        <tbody>
        <tr>
            <td ng-bind="client.id_cl"  name="id_cl" ng-model="client.id_cl"></td>
            <td js-edit="client.name" class="js-editable">
                ...
                <form class="js-editable-form" name="myForm">
                    <input type="text" class="js-editable-input js-editable-field" ng-model="client.name" placeholder="client.name" ng-required/>
            ...
            <td js-edit="client.telephone" class="js-editable">
                ...
                <form class="js-editable-form" name="myForm">
                    <input type="text" class="js-editable-input js-editable-field" ng-model="client.telephone" placeholder="client.name" ng-required/>
                    <button class="js-editable-icon" type="submit"></button>
                </form>
            </td>
            <td  js-edit="client.details" class="js-editable">
                ...
                <form class="js-editable-form" name="myForm">
                    <input type="text" class="js-editable-input js-editable-field" ng-model="client.details" placeholder="client.name" ng-required/>
                    <button class="js-editable-icon" type="submit"></button>
                </form>
            </td>
            <td>
